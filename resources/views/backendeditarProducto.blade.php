        ...
        <input type="hidden" value="{{$shoe['id']}}" name="id">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Nombre" value="{{$shoe['name']}}"
                            required>
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control" id="descripcionPortugues" placeholder="..." name="description_por">
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control" id="descripcionAleman" placeholder="..." name="description_sw">
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control" id="descripcionFrances" placeholder="..." name="description_fr">
                ...
                <div class="row">
                    ...
                    <input type="text" class="form-control" id="capellada" placeholder="Capellada" 
                        name="chapped" value="{{$shoe['chapped']}}"
                            required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="forro" placeholder="forro" 
                            name="cover" value="{{$shoe['cover']}}" required>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="taco" placeholder="taco" 
                            name="heels" value="{{$shoe['heels']}}" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="suela" placeholder="Suela" 
                            name="sole" value="{{$shoe['sole']}}" required>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="stockControll" 
                            name="stock_control" value="{{$shoe['stock_control']}}">
                    ...
                    <div class="col-md-6 mb-3">
                        <input type="checkbox" class="custom-control-input" id="hidden" 
                            name="hidden" value="{{isset($shoe['hidden']) ? $shoe['hidden'] : '1'}}">
